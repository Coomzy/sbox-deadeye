...
public class PlayerSettings : GameResourceSingleton<PlayerSettings>
{
	...
	[Group("Executing"), Property] public float delayBeforeExecute { get; set; } = 0.24f;
	[Group("Executing"), Property] public float delayPerExecute { get; set; } = 0.24f;
	[Group("Executing"), Property] public float delayAfterExecute { get; set; } = 0.24f;
}
